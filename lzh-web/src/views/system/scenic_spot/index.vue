  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:scenic_spot:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:scenic_spot:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:scenic_spot:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:scenic_spot:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="scenic_spotList" @selection-change="handleSelectionChange" border>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="景点城市" prop="city">
        ...
        <el-form-item label="景点简介" prop="introduction">
          <el-input v-model="form.introduction" placeholder="请输入景点简介" />
        </el-form-item>
...
<script>
import { listScenic_spot, getScenic_spot, delScenic_spot, addScenic_spot, updateScenic_spot } from "@/api/system/scenic_spot";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listScenic_spot(this.queryParams).then(response => {
        this.scenic_spotList = response.rows;
    ...
    handleUpdate(row) {
      ...
      getScenic_spot(id).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateScenic_spot(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addScenic_spot(this.form).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/scenic_spot/export', {
        ...this.queryParams
      }, `scenic_spot_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
