<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bannerList" @selection-change="handleSelectionChange" border>
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="ID" width="55" align="center" prop="id" />
      <el-table-column label="标题" width="255" align="center" prop="title" />
      <el-table-column label="链接地址" align="center" prop="link" :show-overflow-tooltip="true" />
...
<script>
import { listBanner, getBanner, delBanner, addBanner, updateBanner } from "@/api/uni/banner";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        link: [
          { required: true, message: "轮播图链接地址不能为空", trigger: "blur" }
        ],
        imgUrl: [
