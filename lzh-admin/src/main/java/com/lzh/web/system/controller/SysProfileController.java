...
import com.lzh.common.utils.file.FileUploadUtils;
import com.lzh.common.utils.file.MimeTypeUtils;
import com.lzh.web.system.service.TokenService;
import com.lzh.web.system.service.ISysUserService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(LzhConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
